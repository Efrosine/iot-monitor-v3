...
<script>
    ...
    function createDeviceCard(device) {
        ...
        if (device.type === 'sensor') {
            ...
            icon = '<svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.5 6.5h5m-5 4h5m-5 4h5M8 2h8a2 2 0 012 2v16a2 2 0 01-2 2H8a2 2 0 01-2-2V4a2 2 0 012-2zm-2 9h12" /></svg>';
        } else {
